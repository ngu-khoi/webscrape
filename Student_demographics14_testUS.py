...
#this program to test get Race (Lowincome corectly or not on whole US School
...
def main():
    global writer
    if os.path.isfile("./data/TestData/table_race_" + statename + ".csv"):
        print("File exist")
        fileHandle = open("./data/TestData/table_race_" + statename + ".csv", "r")
        ...
        outfile = open("./data/table_race_" + statename + ".csv", "a", newline='')
        writer = csv.writer(outfile)
    else:
        print("File not exist")
        outfile = open("./data/TestData/table_race_" + statename + ".csv", "a", newline='')
        writer = csv.writer(outfile)
...
for i in range(1, 100):
    ...
    try:
        f = open('./data/TestData/table_school_US_new.csv', "r")
        if os.path.isfile("./data/TestData/table_race_" + statename + ".csv"):
            fileHandle = open("./data/TestData/table_race_" + statename + ".csv", "r")
        main()
    except:

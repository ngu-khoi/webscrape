...
if os.path.isfile('./data/table_US_combine.csv'):
    ...
    line_main = f_main.readline()
    org_schoolID = ""
    header_line = "State Order,State,School Link,Score,Rate,School,Address,City,State,Zip Code,Type, White, Black, Hispanic, American Indian/Alaska Native, Hawaiian Native/Pacific Islander, Asian, Asian or Asian/Pacific Islander, Filipino, Pacific Islander, Asian or Pacific Islander, Native American or Native Alaskan, Native Hawaiian or Pacific Islander, African-American, American Indian/Alaskan Native, American Indian, White not Hispanic, Black not Hispanic, Native Hawaiian or Other Pacific Islander, Asian/Pacific Islander, Two_or_more_races, Low Income, Male, Female"

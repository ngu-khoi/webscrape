...
def get_all_state_school(statename, next_page):
    ...
    # Create the following directory in C: and write the following path
                ...
                for cell in row.findAll(["td"]):
                    if ' Summary Rating provides an overall snapshot of school quality' in cell.text:
                        ...
                        if 'Currently unrated' in text1:
                            ...
                            ratevalue = cell.contents[0].contents[0].contents[0].contents[0].text
...
if os.path.isfile('table_school_US.csv'):
    ...
    writer = csv.writer(outfile)
    list_of_cellshead = []
    headertext = 'State Order, State, Score, Rate, School, Address, City, State, Zip Code, Type ,Grades ,Total students enrolled ,Students per ' \
